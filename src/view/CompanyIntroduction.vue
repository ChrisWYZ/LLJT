        ...
        <div class="container">
            <div class="row CompanyIntroduction-container">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6">
                    <h3>龙利集团有限责任公司</h3>
                    <p class=".text-justify">&nbsp;&nbsp;&nbsp;&nbsp;11111111111111111111111111111111111111111111.</p>
                    <p class=".text-justify">&nbsp;&nbsp;&nbsp;&nbsp;22222222222222222222222222222222222222222222.</p>
                    <p class=".text-justify">&nbsp;&nbsp;&nbsp;&nbsp;33333333333333333333333333333333333333333333.</p>
                </div>
            </div>
        </div>
    </div>
